...
# TSPNet + bidirectional SSM adapter variant.
# Diff vs run_phoenix_pos_embed_sp_test_3lvl.sh: adds --use-ssm-adapter and
# its hyperparameters. Everything else identical, so any observed change is
