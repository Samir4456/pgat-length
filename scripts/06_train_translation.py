"""Step 06 — stage 2 mBART translation fine-tuning with PGAT variable prefix.

Warm-starts the PGAT encoder from alignment_best.pt and fine-tunes the
whole system (PGAT + projection + mBART) with label-smoothed cross-entropy.

Usage:
    sbatch slurm/train_translation.sbatch --allow-full
    # or interactively:
    python scripts/06_train_translation.py --allow-full
"""
...
from pgat_length.training.translation_loop import train_translation  # noqa: E402
